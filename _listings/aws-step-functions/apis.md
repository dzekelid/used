...
- name: AWS Step Functions API - Send Task Failure
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/used/master/_listings/aws-step-functions/actionsendtaskfailure-get-openapi.md
- name: AWS Step Functions API - Send Task Heartbeat
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/used/master/_listings/aws-step-functions/actionsendtaskheartbeat-get-openapi.md
- name: AWS Step Functions API - Send Task Success
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/used/master/_listings/aws-step-functions/actionsendtasksuccess-get-openapi.md
x-common:
- type: x-api-gallery
